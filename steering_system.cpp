 ...
 namespace lem_dynamics_sim_
{
    ...
    State& x derative_steering(const ParamBank& P, const State& x, const Input& u) {
        ...
        temp.d_delta_left = x.d_rack_angle * derative_with_respect_to_rack_angle_anti_akerman(rack_angle,P).delta_left ;
        temp.delta_right = x.d_delta_right ;
        temp.d_delta_right =  x.d_rack_angle * derative_with_respect_to_rack_angle_anti_akerman(rack_angle,P).delta_right ;
