...
class ComplementaryFilterWrapper
{
public:
    ComplementaryFilterWrapper(ros::NodeHandle& nh,
                               ros::NodeHandle& pnh,
...
private:
    ...
    bool gyro_bias_calibration_done_ = false;
    bool gyro_bias_calibration_started_ = false;
    double gyro_bias_sum_ = 0.0;
    std::size_t gyro_bias_sample_count_ = 0;
    ros::Time gyro_bias_calibration_start_time_;
