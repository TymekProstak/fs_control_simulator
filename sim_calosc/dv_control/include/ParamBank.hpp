...
inline ParamBank build_param_bank(const nlohmann::json& J) {
  ...
  P.add("bang_bang_hist",JgetReq(J,"general.bang_bang_hist"));
  P.add("bang_bang_movment",JgetReq(J,"general.bang_bang_movment"));
  P.add("bang_bang_offset",JgetReq(J,"general.bang_bang_offset"));
  P.add("smoothing_factor_of_pp_result", JgetReq(J,"general.smoothing_factor_of_pp_result"));
