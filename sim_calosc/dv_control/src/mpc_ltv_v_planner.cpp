...
static inline Eigen::Matrix<double, NX, 1> f_splitv_continuous(
    ...
    const Eigen::Matrix<double, NU, 1>& u,   // <<< TERAZ WEKTOR
    double kappa,
    double v_path,
    double v_vehicle,
                               ...
                               double vx_body)
{
    ...
    // vx0_body: preferuj odometrię (vx_body), fallback na v_path[0]
